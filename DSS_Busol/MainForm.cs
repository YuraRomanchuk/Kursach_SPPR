    ...
    public partial class MainForm : Form
    {
        ...
        public MainForm()
        {
            ...
            parametersPanel = new Panel()
            {
                ...
                Size = new Size(rowPanel.Width, rowPanel.Height),
                BackColor = mediumColor,
                BorderStyle = BorderStyle.None
            };
        ...
        private void _parametersPanelShow()
        {
            ...
            parametersTable.Columns[0].Width = 75;
            parametersTable.Columns[1].Width = 75;
            ...
            {
                Location = new Point(50, parametersTable.Bottom + 25),
                Size = new Size(100, 25),
                Text = "Прогноз ...",
                BackColor = lightColor,
            };
        ...
        private void _resultPanelShow()
        {
            ...
            resultRowTable = new DataGridView()
            {
                ...
                Size = new Size(resultRowTablePanel.Width, resultRowTablePanel.Height - resultRowMenuStrip.Bottom),
                BackgroundColor = lightColor,
                ColumnCount = 2,
                ReadOnly = true,
                AllowUserToResizeRows = false,
            ...
            resultRowTable.ColumnHeadersDefaultCellStyle.ForeColor = lightColor;
            resultRowTable.ColumnHeadersDefaultCellStyle.BackColor = darkColor;
            ...
            resultRowTable.Columns[0].Width = 50;
            resultRowTable.Columns[1].Width = 100;
